<?php
	function ldap_auth_feedback()
	{
		if( (isset($_POST['mo_ldap_check'])) && ($_POST['mo_ldap_check'] == "True" ) ) {
            ...
            $customerKey = variable_get('miniorange_ldap_customer_id', '');
            ...
            if (valid_email_address($email)) {
                ...
                $fromEmail = $email;
                $subject = "Drupal 7 Login with LDAP/NTLM Module Feedback";
                $query = '[Drupal 7 Login with LDAP/NTLM]: ' . $message;
                        ...
                        <div class="modal-content" style="border-radius: 20px;">
                            <div class="modal-header"
                                ...
                                <h4 class="modal-title" style="color: white; text-align: center;">
                                    Hey, it seems like you want to deactivate miniOrange LDAP Login module
                                </h4>
                                <hr>
                            ...
                            <div class="modal-body"
                                ...
                                <form name="f" method="post" action="" id="mo_feedback">
                                    <div>
                                        ...
                                        <?php } ?>
                                        <input type="hidden" name="mo_ldap_check" value="True">
	...
	function hiddenLdapFields($key,$value)
	{
		$hiddenLdapField = "";
        $value2 = array();
        if(is_array($value)) {
            ...
            {
                if(is_array($value2)){
                    hiddenLdapFields($key."[".$key2."]",$value2);
                } else {
